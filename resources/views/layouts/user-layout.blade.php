...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <ul class="nav align-items-center d-md-none">
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false">
                    <i class="ni ni-single-02"></i> Text
                </a>
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    <a class="dropdown-item" href="#">
                        <i class="ni ni-single-02 text-default"></i> My Profile
                    </a>
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a href="http://sohailkhan.local/ZamaSehat">
                            Logo
                        </a>
                    </div>
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="http://sohailkhan.local/ZamaSehat" title="Home">
                        <i class="ni ni-building text-default"></i> Home
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://sohailkhan.local/ZamaSehat/admin" title="Dashboard">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Doctor">
                        <i class="ni ni-single-02 text-default"></i> Doctor</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Disease">
                        <i class="ni ni-sound-wave text-default"></i> Disease</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Approval Request">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Appointment">
                        <i class="ni ni-calendar-grid-58 text-default"></i> Appointment</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Patient">
                        <i class="ni ni-ambulance text-default"></i> Patient</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Feedback">
                        <i class="ni ni-collection text-default"></i> Feedback</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" title="Logout">
                        <i class="ni ni-user-run text-default"></i> Logout</a>
                </li>
            </ul>
        </div>
    </div>
