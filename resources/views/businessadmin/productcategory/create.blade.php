        ...
        <div class="col-md-12">
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    ...
                    {{ Form::open(['action' => 'BuProductCategoryController@store','onsubmit' => 'return loadingCss(this);']) }}
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                {{ Form::label('','Category Name') }}
                                <small style="color: red;"> *</small>
                                {{ Form::text('product_category_name',null,['class' => 'form-control','required','placeholder' => 'Product category name']) }}
                            </div>
                        </div>
                    </div>
                    <div class="row">
