...
@section('title','Add Supplier Receipt')
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <h3>
                        ...
                        <a style="float: right;" href="{{ route('br-supplierreceipt.index') }}"
                    ...
                    <div class="row">
                            ...
                            <div class="form-group mb-0">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control" placeholder="Enter Supplier name" type="text"
                                           id="search_text" onblur="getSupplier()">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-2">
                            <button type="button" id="search_btn" class="btn btn-default" onclick="searchSupplier()">
                                Search
                            </button>
                        </div>
                        <div class="col-md-1"></div>
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['action' => 'BrPurchasedReceiptController@store','onsubmit' => 'return loadingCss(this);']) }}
...
@section('script_content')
    ...
    <script>
            ...
            if (search_data == '') {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        document.getElementById('supplier').innerHTML = data;
                    }
                });
            }
        }
        ...
        function searchSupplier() {
            ...
            var search_data = $('#search_text').val();
            if (search_data == '' || search_data == null || supplier_id == '' || supplier_id == null) {
                document.getElementById('search_text').style.border = "1px solid #d71313";
                ...
                document.getElementById('supplier').style.border = "1px solid #cad1d7";
                var data = "supplier_id=" + supplier_id;
                $.ajax({
                    type: "POST",
                    url: '{{ URL::to('/getsupplierdata') }}',
                    data: data,
                    success: function (data) {
