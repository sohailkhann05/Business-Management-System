<div class="table-responsive">
    <table class="table table-flush">
        ...
        <tr>
            ...
            <td>
                {{ $product->product_purchased_unit }}
                <input type="hidden" id="return_unit" value="{{ $product->product_purchased_unit }}">
            </td>
            <td>
               <input type="number" id="return_quantity_1" class="form-control" style="width: 60px;" required min="0">
            </td>
            <td>
               <input type="number" id="return_quantity_2" class="form-control" style="width: 60px;" required min="0">
            </td>
            <td>
