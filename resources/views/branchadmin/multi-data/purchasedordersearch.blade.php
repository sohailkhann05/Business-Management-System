<div class="row">
    <div class="col-md-12">
        <div class="card shadow">
            <div class="card-body">
                @if($order)
                    <h3 class="mb-4">Purchased Order Return</h3>
                    {{ Form::open(['action' => 'BrPurchasedOrderReturnController@store','onsubmit' => 'return loadingCss(this);']) }}
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group" id="adding-form">
                                {{ Form::submit('Create Purchase Order Return',['class' => 'btn btn-sm btn-default']) }}
                            </div>
                        </div>
                    </div>
                    {{ Form::close() }}
