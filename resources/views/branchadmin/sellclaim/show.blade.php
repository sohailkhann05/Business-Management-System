...
@section('body_content')
    ...
    <?php $claims = $claim->sellClaimDetails->where('claim_status', 0); ?>
    <?php $claimed = $claim->sellClaimDetails->where('claim_status', 1); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <h3>
                        ...
                        @endif
                        @if($claimed->count() > 0)
                            <a href="{{ route('br-customerclaim.edit',$claim->id) }}" style="float: right;" class="btn btn-sm btn-default">
                    ...
                    @if($claims->count() > 0)
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                <?php $sno = 1; ?>
                                @foreach($claimed as $claimDetail)
                                    <tr>
                                        <td>{{ $sno++ }}</td>
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['action' => 'BrSellClaimController@store','onsubmit' => 'return loadingCssAddClaim(this);']) }}
                    ...
                    <div class="form-group">
                        ...
                        <small> *</small>
                        <input type="number" required name="quantity" min="0" class="form-control" placeholder="Quantity">
                    </div>
                    <div class="form-group">
                        <label for="">Defect Reason</label>
                        <small> *</small>
                        <textarea name="defect_reason" rows="2" required class="form-control" placeholder="Defect Reason..."></textarea>
                    </div>
                </div>
    ...
    <div class="modal fade" id="delete_product" tabindex="-1" role="dialog" aria-labelledby="modal-default"
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    {{ Form::open(['method' => 'delete','action' => ['BrSellClaimController@destroy',Auth::guard('branch-admin')->id()],'onsubmit' => 'return loadingCssDeleteClaim(this);']) }}
    ...
    <div class="modal fade" id="confirm_claim" tabindex="-1" role="dialog" aria-labelledby="modal-default"
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    {{ Form::open(['method' => 'put','action' => ['BrSellClaimController@update',Auth::guard('branch-admin')->id()],'onsubmit' => 'return loadingCssConfirmClaim(this);']) }}
...
@section('script_content')
    ...
    <script>
        ...
        function addToClaim(user_id, purchased_order_id, product_id) {
            $('#userId').val(user_id);
            $('#sellOrderId').val(purchased_order_id);
