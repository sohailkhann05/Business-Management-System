...
@section('title','Create Purchased Order Return')
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button type="button" id="search_btn" class="btn btn-default" onclick="searchInvoice()">
                                Search
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        function searchInvoice() {
            ...
            if (search_data == '' || search_data == null) {
                ...
                $.ajax({
                    type: "POST",
                    url: '{{ URL::to('/branchadmin/branch-search-invoice') }}',
                    data: data,
