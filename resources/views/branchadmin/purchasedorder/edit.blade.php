            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <h3>
                        ...
                        <a style="float: right;" href="{{ route('br-purchasedorder.show',$order->id) }}"
                            ...
                            <div class="col-md-12">
                                <div class="pl-md-5">
                                    ...
                                    <table class="table text-center table-bordered">
                                        ...
                                        ?>
                                        <tbody>
                                        @foreach($order->productPurchased as $detail)
                                            <tr>
                                                <td>
                                                    {{ $detail->product->product_name }}
                                                </td>
                                                <td>
                                                    {{ $detail->product_purchased_quantity }}
                                                </td>
                                                <td>
                                                    Rs.{{ $detail->per_product_price }}
                                                </td>
                                                <?php $sum = $detail->per_product_price * $detail->product_purchased_quantity; ?>
                                            </tr>
                                            <?php
