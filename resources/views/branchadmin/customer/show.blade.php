...
@section('body_content')
    ...
    $i = 1;
    $total = 0;
    $orders = $client->sellOrder()->orderBy('created_at', 'desc')->limit(5)->get();
    $count = $orders->count();
    ?>
    <div class="card card-profile shadow">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3>
                        Orders History
                        @if($count > 0)
                            <a href="{{ route('br-orderhistory.show',$client->id) }}" style="float: right;"
                               class="btn btn-sm btn-default">View All Order History</a>
                        @endif
                    </h3>
                    <hr>
                    @if($count > 0)
        ...
        <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['method' => 'put','action' => ['BrCustomerController@update',$client->id],'onsubmit' => 'return loadingCss(this);']) }}
