...
class BrClientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('branchadmin.client.index', compact('clients'));
    }
    ...
    {
        $categories = UserCategory::where('business_id', Auth::guard('branch-admin')->user()->branch->business_id)->get();
        $select_category = [];
        foreach ($categories as $category) {
            if ($category->user_category_name == 'Supplier')
                $select_category[$category->id] = $category->user_category_name;
        }
        return view('branchadmin.client.create', compact('select_category'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('info', 'Supplier created successfully.');
        return redirect('/branchadmin/br-supplier/' . $user->id);
    }
    ...
    {
        $client = User::find($id);
        return view('branchadmin.client.show', compact('client'));
    }
    ...
    {
        return view('branchadmin.client.edit');
    }
